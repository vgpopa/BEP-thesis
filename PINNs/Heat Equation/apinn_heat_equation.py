...
#analytic solution to heat equation
k = 1
def heat(t,x):
...
def adam():
    ...
    for i in range(epochs):
        ...
        optimizer.zero_grad()
        up = model(Xtrain) #prediction at collocation points
        mse = nn.MSELoss()
        ...
        physics = u_t-k*u_xx #residue of heat equation PDE
...
#plots prediction and solution at various times
plt.figure()
plt.title('t = 0.5')
t=0.5
...
#anim.save('Heat_vid.mp4', dpi = 300, writer=writer)