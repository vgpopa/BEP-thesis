...
upredict = model(Xpredict).detach().cpu()#.float().to(mydevice)
...
plt.xlabel(r'$\it{epochs}$')
plt.ylabel(r'$\mathcal{L}$',labelpad=15,rotation='horizontal')
plt.yscale("log")

#plots of prediction and solution at various times
plt.figure()
plt.title('t = 0.5')
t=0.5
